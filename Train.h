...
private:
    ...
    sjtu::bpt<size_t, train, 200,5, 2> tra;
    sjtu::bpt<sjtu::pair<size_t, int>, Left_Ticket, 150, 50, 6> Tk;
    sjtu::bpt<type3, Stations, 150, 100, 6> sta;

    sjtu::bpt<type1, Ticket, 150, 50, 2> Get_ticket;//(username,kth) -> Ticket
